...
void FixOffsets() {
	...
	*(FARPROC*)&RtlGetVersion = GetProcAddress(GetModuleHandleA("ntdll"),
	...
	case 10586: //WIN10_TH2
		...
		break;
	default:
		printf("[X] This cheat does not support your windows version/build. Message the developers this number: %d\n", build);
		exit(0);
		break;
	}
	printf("[+] Windows Version is supported!\n", build);
}
